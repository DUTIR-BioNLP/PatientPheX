...
- 下载《数据集使用条款》在文档末尾填写参赛队伍信息，参赛队伍负责人签名（电子签即可）。将签名的文件（PDF）发送至以下邮箱dutir_bionlp@163.com，邮件标题为：“参赛单位-队伍名称-PatientPheX数据使用申请”。
...
<img src=https://static.tianchi.aliyun.com/tianchi/race/images/prod/532512/1242990779776242/otzc88vq6rj6nqcs.png >
